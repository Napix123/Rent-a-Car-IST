...
const KartaPopularno = ({ broj, model }) => {
  return (
    ...
    >
      <div
        className="splash"
        style={{ backgroundColor: Tema.palette.common.black }}
      />
      <motion.div className="card" variants={cardVariants}>
        <div className="broj" style={{ color: Tema.palette.common.black }}>
          {broj}
        </div>
        <br />
...
const Najpopularnije = () => {
  ...
  return (
    <div>
      {" "}
      <Naslov tekst={"Najpopularnije"} klasa={"NaslovObican"} />
      <div
        className="najpopularnije"
        style={{ backgroundColor: Tema.palette.common.white }}
      >
        {Auto &&
