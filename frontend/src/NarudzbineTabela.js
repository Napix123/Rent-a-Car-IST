...
import PretragaNarudzbina from "./PretrazivanjeNarudzbina";
...
function NarudzbineTabela() {
  ...
  return (
    <Box component="section" sx={{ p: 2 }}>
      <Box m={5}>
        <PretragaNarudzbina PostaviRedove={setRows} />
      </Box>
            ...
            <TableBody>
              {(rowsPerPage > 0
                ? rows &&
                  ...
                  ) // Dodajte proveru da li je rows definisan pre poziva slice
                : rows
              ).map((uzeto) => (
                <TableRow key={uzeto.id}>
                  ...
                  <TableCell style={{ width: 160, textAlign: "left" }}>
                    <Button
                      ...
                      onClick={() => Brisanje(uzeto._id)}
                      style={{
                        backgroundColor: Tema.palette.common.blackT,
                        color: Tema.palette.common.whiteT,
                      }}
                    >
                      Obrisi
                    </Button>
                  ...
                  <TableCell style={{ width: 160, textAlign: "left" }}>
                    {!uzeto.ocena ? (
                      <Button
                        ...
                        style={{
                          backgroundColor: Tema.palette.common.blackD,
                          color: Tema.palette.common.whiteD,
                        }}
                      >
                        Vrati
                      </Button>
...
export default NarudzbineTabela;
