...
const IzmeniAutomobil = () => {
  ...
  const [cena, setCena] = useState(auto.cena);
  const [godiste, setGodiste] = useState(auto.godiste);
  const [klima, setKlima] = useState(auto.klima);
